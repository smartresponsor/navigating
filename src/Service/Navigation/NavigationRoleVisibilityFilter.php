...
use App\Navigating\ServiceInterface\Navigation\NavigationRequestRoleProviderInterface;
use App\Navigating\Value\Navigation\NavigationShellGroup;
use Symfony\Component\HttpFoundation\Request;

final readonly class NavigationRoleVisibilityFilter
{
    /**
     * @param array<string, mixed> $navigationConfig
     */
    public function __construct(
        private NavigationRequestRoleProviderInterface $roleProvider,
